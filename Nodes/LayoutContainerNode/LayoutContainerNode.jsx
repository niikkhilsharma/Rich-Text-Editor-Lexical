...
function $convertLayoutContainerElement(domNode) {
  // Read inline style directly instead of getComputedStyle
  const templateColumns = domNode.style.gridTemplateColumns;

  console.log("Template columns found:", templateColumns);
...
export class LayoutContainerNode extends ElementNode {
  ...
  static importDOM() {
    return {
      div: (domNode) => {
        // Check if this div has the layout-container attribute
